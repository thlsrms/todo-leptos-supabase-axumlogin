    ...
    view! {
      <div id="top-nav-bar" class="uk-position-small uk-position-top">
        ...
        >
          <div class=move || {
              format!(
                  "uk-container uk-background-{0} uk-{1} bg-toggle",
                ...
                <div style:display=show_if_logged_out>
                  <ul class="uk-navbar-nav">
                    <li>
                      ...
                      >
                        <span class="uk-icon uk-margin-small-left" uk-icon="sign-in"></span>
                        "Sign in"
                      </a>
                    </li>
                  </ul>
                  ...
                  <ul class="uk-navbar-nav">
                    <li>
                      <a
                        ...
                        class="uk-navbar-item uk-text-primary uk-button uk-button-link"
                      >
                        <span class="uk-icon uk-margin-small-left" uk-icon="user"></span>
                        "User Settings"
                      </a>
                    </li>
                    <li>
...
async fn sign_out() -> Result<(), ServerFnError> {
    ...
    match auth_session.logout().await {
        Ok(u) => {
            ...
            supabase
                .client
                .logout(user.identity.auth_token)
                .await
